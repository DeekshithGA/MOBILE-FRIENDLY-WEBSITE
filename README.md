Responsive Website – README Overview A modern, mobile-friendly website built with HTML, CSS, and JavaScript. It features responsive layout, dark mode, animations, and interactive elements.
